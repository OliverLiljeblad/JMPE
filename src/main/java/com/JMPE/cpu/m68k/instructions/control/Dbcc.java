...
public final class Dbcc {
    ...
    public static boolean isConditionTrue(int rawCondition, Bcc.ConditionCodesReader conditionCodesReader) {
        return switch (rawCondition) {
            ...
            default -> throw new IllegalArgumentException("Condition must be in range 0x0..0xF");
        };
    }
}
