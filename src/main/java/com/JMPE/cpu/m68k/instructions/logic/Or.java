...
/**
 * Implements the execution semantics of the Motorola 68000 OR instruction.
 * This helper reads decoded sized operands, writes the sized bitwise-OR result, and updates the CCR flags.
