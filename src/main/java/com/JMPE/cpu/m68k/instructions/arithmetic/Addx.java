...
/**
 * Implements the execution semantics of the Motorola 68000 ADDX instruction.
 */
public final class Addx {
    ...
    private static void updateConditionCodes(
        ...
        long unsignedResult = unsignedDestination + unsignedSource + extend;
        boolean carry = unsignedResult > Integer.toUnsignedLong(size.mask(-1));
