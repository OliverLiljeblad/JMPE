...
/**
 * Implements the execution semantics of the Motorola 68000 EOR instruction.
 * This helper reads decoded sized operands, writes the sized bitwise-exclusive-OR result, and updates the CCR flags.
